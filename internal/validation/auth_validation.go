...
func (v *AuthValidation) ValidateRegisterRequest(req dto.ApplicantRegisterRequest) error {
	return v.validate.Struct(req)
}

func (v *AuthValidation) ValidateLoginRequest(req dto.ApplicantLoginRequest) error {
	return v.validate.Struct(req)
}
...
func (v *AuthValidation) ValidateSendVerificationEmailRequest(req dto.SendVerificationEmailRequest) error {
	return v.validate.Struct(req)
}

func (v *AuthValidation) ValidateVerifyEmailRequest(req dto.VerifyEmailRequest) error {
	return v.validate.Struct(req)
}
